...
const Lecturers = () => {
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setNewLecturer(prev => ({ ...prev, department: e.target.value }))}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
  ...
  const ViewLecturerModal = () => {
    if (!showViewModal || !selectedLecturer) return null;
                  ...
                  <tr key={lecturer.id} className="hover:bg-gray-50">
                    <td className="px-6 py-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="text-sm font-medium text-gray-900">{lecturer.name}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4 text-sm text-gray-900">{lecturer.email}</td>
                    <td className="px-6 py-4 text-sm text-gray-900">{lecturer.department}</td>
                    <td className="px-6 py-4 text-sm text-gray-900">{lecturer.courseAssigned}</td>
                    <td className="px-6 py-4">
